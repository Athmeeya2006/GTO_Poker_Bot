...
# Kuhn Nash solution
print("\nVerifying Kuhn Nash solution (exact analytical values)...")
...
print(f"  P0 K: bet    {k_bet:.4f}  (expected: 3*alpha)")
print(f"  P0 Q: bet    {q_bet:.4f}  (expected: 0)")
print(f"  P0 J: bluff  {j_bluff:.4f}  (equilibrium alpha in [0, 1/3])")
print(f"  P0 Q:cb call {q_call_after_cb:.4f}  (expected: alpha + 1/3)")
...
# Cross-validate exploitability methods
print("\nCross-validating tree-traversal vs brute-force exploitability...")
...
# CFR+ vs Vanilla vs DCFR convergence
print("\nVerifying convergence of all CFR variants...")
...
# Opponent model - GTO opponent has KL ~ 0
print("\nVerifying Dirichlet model KL behavior...")
...
# SPRT detects nit quickly
print("\nVerifying SPRT leak detection speed...")
...
print("\nVerifying Glosten-Milgrom mapping + trading signals...")
...
# MCCFR variance reduction
print("\nVerifying MCCFR baseline calibration...")
...
# Posterior variance confidence gating
print("\nVerifying posterior variance confidence gating...")
...
# Leduc solver convergence
print("\nVerifying Leduc Poker solver convergence...")
...
print("\nVerifying game engine integration...")
